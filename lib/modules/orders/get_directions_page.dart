...
class _MapViewState extends State<MapView> {
  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      List destinationPlacemark = await locationFromAddress(_destinationAddress);
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        _southwestCoordinates = geo.Position(
            speed: _currentPosition.speed,
            heading: _currentPosition.heading,
            accuracy: _currentPosition.accuracy,
            altitude: _currentPosition.altitude,
            ...
            latitude: miny,
            longitude: minx);
        _northeastCoordinates = geo.Position(
            speed: _currentPosition.speed,
            heading: _currentPosition.heading,
            accuracy: _currentPosition.accuracy,
            altitude: _currentPosition.altitude,
                                    ...
                                    _calculateDistance().then((isCalculated) {
                                      if (isCalculated) {
                                        ...
                                        FlushbarUtils().showSuccessFlushbar(
                                            "Success!", "Distance Calculated Sucessfully", context);
                                      } else {
                                        // ScaffoldMessenger.of(context)
                                        //     .showSnackBar(
                                        //   SnackBar(
                                        ...
                                        FlushbarUtils().showErrorFlushbar(
                                            "Error!", "Error Calculating Distance", context);
                                      }
                                    });
                                  }
                                : null,
